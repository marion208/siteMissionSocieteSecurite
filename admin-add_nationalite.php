...
?>
        ...
        <body>
            ...
            <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
                <div class="container-fluid">
                    <a class="navbar-brand" href="/admin-liste_type_planques.php"><img src="/open-iconic-master/svg/arrow-left.svg" style="zoom: 200%;"> Retour à la liste des nationalités</a>
                </div>
            </nav>

            <div class="container">
                <h5>Veuillez renseigner ci-dessous les informations pour ajouter une nouvelle nationalité.</h5>
                ...
                $controller->formAddNewNationalite();
                ?>
            </div>
