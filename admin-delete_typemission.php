...
?>
        ...
        <body>
            ...
            <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
                <div class="container-fluid">
                    <a class="navbar-brand" href="/admin-liste_admins.php"><img src="/open-iconic-master/svg/arrow-left.svg" style="zoom: 200%;"> Retour à la liste des types de missions</a>
                </div>
            </nav>
            ...
            ?>
                <div class="container">
                    Confirmez-vous la suppression du type de mission ci-dessous ?
                <?php
                $controller->searchInfoforTypeMissionId();
            }
                ?>
                <br>
                <a href="/models/deleteTypeMission.php?id=<?php echo $idTypeMission; ?>">
