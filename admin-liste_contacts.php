...
?>
        ...
        <body>
            ...
            <div class="container">
                ...
                <?php
                // Vérifier s'il y a des contacts en base de données
                include 'Controller/controller_contact.php';
                $controller = new ControllerContact();
                $controller->checkIfContactInDB();
                $nbContactsInDB = $_SESSION['nbContactsInDB'];

                // Si aucun contact en base de données, on affiche un message associé pour prévenir l'utilisateur
                if ($nbContactsInDB == 0) {
                    include 'views/messageNoContactInDB.php';
                }
                // Sinon on importe la liste des contacts présentes en base de données
                else {
