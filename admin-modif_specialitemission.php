...
?>
        ...
        <body>
            ...
            <?php
            // Vérifier si le type de planque existe en base de données
            ...
            // Si aucun type de planque existe avec l'identifiant donné, on affiche un message associé pour prévenir l'utilisateur
            ...
            ?>
                ...
                <?php
                $controller->formModificationForSpecialityMission();
            }
                ?>
                </div>
                <!-- jQuery -->
