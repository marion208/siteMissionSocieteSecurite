...
?>
        ...
        <body>
            ...
            <?php
            // Vérifier si le statut de planque existe en base de données
            ...
            // Si aucun statut de planque existe avec l'identifiant donné, on affiche un message associé pour prévenir l'utilisateur
            ...
            ?>
                ...
                <?php
                $controller->formModificationForStatutMission();
            }
                ?>
                </div>
                <!-- jQuery -->
