...
if (count($listErrors) == 0) {
    $req = $bdd->prepare('INSERT INTO liste_specialites_mission (designationSpecialiteMission) VALUES(?)');
    ...
    header("Location: http://localhost/admin-add_specialitemission.php");
    exit;
}
